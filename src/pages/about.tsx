  ...
  return (
    <Layout>
      ...
      <div className="max-w-3xl mx-auto w-full py-12 px-4 md:px-0">
        {/* Hide this card on mobile, show on md+ */}
        <Card className="mb-8 bg-gradient-to-br from-blue-50/80 to-indigo-50/60 dark:from-gray-800 dark:to-gray-900 shadow-lg hidden md:block">
